          ...
          <div class="full">
            <div class="topbar-left">
              <ul class="list-inline">
                ...
                <li> <span class="topbar-label"><i class="fa fa-envelope-o"></i></span> <span class="topbar-hightlight"><a href="mailto:info@lojas.org.ng">info@lojas.org.ng</a></span> </li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li> <a href="it_shop.html">Payments</a>
                  <ul>
                ...
                <li> <a href="it_shop.html">Submissions</a>
                  <ul>
                    <li><a href="it_shop.html">Shop List</a></li>
                    <li><a href="it_shop_detail.html">Shop Detail</a></li>
                    <li><a href="it_cart.html">Shopping Cart</a></li>
